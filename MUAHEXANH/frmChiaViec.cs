...
namespace MUAHEXANH
{
    public partial class frmChiaViec : Form
    {
        ...
        private void frmChiaViec_Load(object sender, EventArgs e)
        {
            ...
            this.sp_lay_dsphancong_tu_doiTableAdapter.Fill(this.dSchiaViec.sp_lay_dsphancong_tu_doi, maDoi, DateTime.Parse(deNgay.Text), cmbBuoi.Text);
            this.sp_lay_dscongviec_tu_doiTableAdapter.Connection.ConnectionString = Program.connstr;
            this.sp_lay_dscongviec_tu_doiTableAdapter.Fill(this.dSchiaViec.sp_lay_dscongviec_tu_doi, maDoi);
        ...
        private void btnGhi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                string cmd = "INSERT INTO PHANCONG VALUES('"
                ...
                if (hd_them != 0)
                {
                    MessageBox.Show("Lỗi thêm việc cho nhóm. Nhóm này đã được phân việc ngày này!", "", MessageBoxButtons.OK);
                    return;
                }
                MessageBox.Show("thêm việc cho nhóm thành công", "", MessageBoxButtons.OK);
                //this.ttsv_trong_nhomTableAdapter.Fill(this.dSchiaNhom.ttsv_trong_nhom);

            }
            catch (Exception ex)
            {
                MessageBox.Show("Lỗi thêm công việc cho nhóm!", "", MessageBoxButtons.OK);
